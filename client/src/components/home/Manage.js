...
export default function Manage() {
    ...
    return (
        <div>
            ...
            <form className="form col-xl-4 col-md-6 col-sm-12 mx-auto mt-4 border border-dark p-3">
                
                <div className="card-header bg-purple text-light"><h3>New operation</h3></div>
                
                <div className="form-group mt-3">
                <label for="type" class="form-label">Type:</label>
                <input onChange={updateState} id="type" className="form-control" name="type" type="text" placeholder="Type"></input>   
                </div>
                <div className="form-group">
                <label for="amount" class="form-label">Amount:</label>
                <input onChange={updateState} id="amount" className="form-control" name="amount" type="number"></input>   
                </div>
                <div className="form-group">
